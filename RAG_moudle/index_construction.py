...
from LLM.init_llm import qwenembedding
...
class IndexConstructionModule:
    ...
    def __init__(self, model_name: str = "text-embedding-v3", index_save_path: str = "./vector_index"):
        """
        初始化索引构建模块
